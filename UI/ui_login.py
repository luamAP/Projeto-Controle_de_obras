...
"}")
        ...
        self.txt_login_nome = QLineEdit(self.frame)
        self.txt_login_nome.setObjectName(u"txt_login_nome")
        self.txt_login_nome.setGeometry(QRect(70, 60, 221, 20))
        self.txt_login_nome.setAlignment(Qt.AlignCenter)
        ...
        QWidget.setTabOrder(self.txt_login_nome, self.txt_login_senha)
    ...
    def retranslateUi(self, login):
        ...
        self.txt_login_nome.setPlaceholderText(QCoreApplication.translate("login", u"Usu\u00e1rio", None))
        self.label.setText("")
    # retranslateUi
